...
HabitEntry.create(habit_content: "Drink 8 glasses of water.", user_id: blake.id)

#Use ActiveRecord to pre-associate data:

blake.habit_entries.create(habit_content: "Run 3 miles")

lizs_habit = liz.habit_entries.build(habit_content: "Meditate for 10 minutes.")
